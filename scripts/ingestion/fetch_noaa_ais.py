...
BBOXES = {
    ...
    "mid_atlantic":       (-80.0, 32.0, -68.0, 40.0),    # widened: captures NC/SC coast + offshore lanes
    "santa_barbara":      (-123.0, 32.0, -117.0, 36.5),  # widened: connects to gulf_farallones, more offshore
    "gulf_farallones":    (-125.0, 35.5, -121.0, 38.5),  # widened: connects to santa_barbara, more offshore
    "san_pedro_channel":  (-120.5, 32.0, -117.0, 34.5),  # widened south edge to match santa_barbara
}
# Columns to keep
